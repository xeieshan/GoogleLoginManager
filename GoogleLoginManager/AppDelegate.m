...
- (BOOL)application:(UIApplication *)application
  ...
  sourceApplication:(NSString *)sourceApplication
    ...
    if ([GoogleLoginManager handleURL:url sourceApplication:sourceApplication annotation:annotation]) {
        return [GoogleLoginManager handleURL:url sourceApplication:sourceApplication annotation:annotation];
    }
    return YES;
}
@end
